...
const styles = StyleSheet.create({
  card:    { backgroundColor: colors.ink2, borderWidth: 1, borderColor: colors.line, padding: 24, marginTop: 14 },
  ...
  cta:     { backgroundColor: colors.vermilion, padding: 14, alignItems: 'center' },
